...
if has("menu") && has("gui_running") && &go =~ 'm' && !exists("s:firstmenu")
 ...
 exe 'menu AlignMaps.<<\ and\ >><tab>'.s:emapleader.'a<	'.s:mapleader.'a<'
 exe 'menu AlignMaps.Assignment\ =<tab>'.s:emapleader.'t=	'.s:mapleader.'t='
 exe 'menu AlignMaps.Assignment\ :=<tab>'.s:emapleader.'a=	'.s:mapleader.'a='
 exe 'menu AlignMaps.Backslashes<tab>'.s:emapleader.'tml	'.s:mapleader.'tml'
 exe 'menu AlignMaps.Breakup\ Comma\ Declarations<tab>'.s:emapleader.'a,	'.s:mapleader.'a,'
 exe 'menu AlignMaps.C\ Comment\ Box<tab>'.s:emapleader.'abox	'.s:mapleader.'abox'
 exe 'menu AlignMaps.Commas<tab>'.s:emapleader.'t,	'.s:mapleader.'t,'
 exe 'menu AlignMaps.Commas<tab>'.s:emapleader.'ts,	'.s:mapleader.'ts,'
 exe 'menu AlignMaps.Commas\ With\ Strings<tab>'.s:emapleader.'tsq	'.s:mapleader.'tsq'
 exe 'menu AlignMaps.Comments<tab>'.s:emapleader.'acom	'.s:mapleader.'acom'
 exe 'menu AlignMaps.Comments\ Only<tab>'.s:emapleader.'aocom	'.s:mapleader.'aocom'
 exe 'menu AlignMaps.Declaration\ Comments<tab>'.s:emapleader.'adcom	'.s:mapleader.'adcom'
 exe 'menu AlignMaps.Declarations<tab>'.s:emapleader.'adec	'.s:mapleader.'adec'
 exe 'menu AlignMaps.Definitions<tab>'.s:emapleader.'adef	'.s:mapleader.'adef'
 exe 'menu AlignMaps.Function\ Header<tab>'.s:emapleader.'afnc	'.s:mapleader.'afnc'
 exe 'menu AlignMaps.Html\ Tables<tab>'.s:emapleader.'Htd	'.s:mapleader.'Htd'
 exe 'menu AlignMaps.(\.\.\.)?\.\.\.\ :\ \.\.\.<tab>'.s:emapleader.'a?	'.s:mapleader.'a?'
 exe 'menu AlignMaps.Numbers<tab>'.s:emapleader.'anum	'.s:mapleader.'anum'
 exe 'menu AlignMaps.Numbers\ (American-Style)<tab>'.s:emapleader.'aunum	<Leader>aunum	'.s:mapleader.'aunum	<Leader>aunum'
 exe 'menu AlignMaps.Numbers\ (Euro-Style)<tab>'.s:emapleader.'aenum	'.s:mapleader.'aenum'
 exe 'menu AlignMaps.Spaces\ (Left\ Justified)<tab>'.s:emapleader.'tsp	'.s:mapleader.'tsp'
 exe 'menu AlignMaps.Spaces\ (Right\ Justified)<tab>'.s:emapleader.'Tsp	'.s:mapleader.'Tsp'
 exe 'menu AlignMaps.Statements\ With\ Percent\ Style\ Comments<tab>'.s:emapleader.'m=	'.s:mapleader.'m='
 exe 'menu AlignMaps.Symbol\ <<tab>'.s:emapleader.'t<	'.s:mapleader.'t<'
 exe 'menu AlignMaps.Symbol\ \|<tab>'.s:emapleader.'t\|	'.s:mapleader.'t|'
 exe 'menu AlignMaps.Symbol\ @<tab>'.s:emapleader.'t@	'.s:mapleader.'t@'
 exe 'menu AlignMaps.Symbol\ #<tab>'.s:emapleader.'t#	'.s:mapleader.'t#'
 exe 'menu AlignMaps.Tabs<tab>'.s:emapleader.'tab	'.s:mapleader.'tab'
 unlet s:mapleader
 unlet s:emapleader
endif
